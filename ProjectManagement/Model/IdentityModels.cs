...
namespace ProjectManagement
{
    public static class IdentityHelper
    {
        ...
        {
            string accountPasswordPart = request.Url.ToString().Contains("localhost") ? "/Account/ResetPassword?" :  "/PM-Biostat/Account/ResetPassword?";
        ...
        {
            string accountConfirmPart = request.Url.ToString().Contains("localhost") ? "/Account/Confirm?" : "/PM-Biostat/Account/Confirm?";
